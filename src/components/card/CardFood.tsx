...
const recipeId = 1;
const recipeImage = "/assets/banner-dashboard.png";
const recipeTitle = "បង្អែមសាច់គោ";
const cookingTime = "30 នាទី";
const cookingLevel = "ងាយ";

export default function RecipeCard2() {
    const image = recipeImage;
    return (
        <Link
            href={`/explore-recipe/${recipeId}`}
        ...
        >
            ...
            <div className="flex flex-grow items-center justify-between p-3">
                <div className="flex flex-col gap-1">
                    <h1 className="text-xs font-medium text-slate-700">{recipeTitle}</h1>
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs">{cookingTime}</span>
                    </div>
                    <div className="bg-[#FFEBBB] text-center rounded-[6px] w-[80px]">
                        <span className="text-[#AE7C00] text-xs ">{cookingLevel}</span>
                    </div>
                </div>
